...
<body>
    ...
    <form method="POST" action="">
        ...
        <div class="crudContainer">
            ...
            <input type="text" name="judul" id="judul" value="<?php echo $filmData['judul']; ?>">
            ...
            <input type="text" name="director" id="director" value="<?php echo $filmData['director']; ?>">
            <label for="cast">Cast Utama</label>
            <input type="text" name="cast" id="cast" value="<?php echo $filmData['cast']; ?>">
            <div class="dateContainer">
                <div>
                    <label for="release_date">Date Release</label>
                    <input type="date" name="release_date" id="release_date" value="<?php echo $filmData['release_date']; ?>">
                </div>
                <div>
                    <label for="usia">Batas Usia</label>
                    <input type="text" name="usia" id="usia" value="<?php echo $filmData['usia']; ?>">
                </div>
            </div>
            <label for="genre">Genre</label>
            <input type="text" name="genre" id="genre" value="<?php echo $filmData['genre']; ?>">
            <label for="link">Link Film</label>
            <input type="text" name="link" id="link" value="<?php echo $filmData['link']; ?>">
            <label for="sinopsis">Sinopsis</label>
            <textarea name="sinopsis" id="" cols="30" rows="10"><?php echo $filmData['sinopsis']; ?></textarea>
